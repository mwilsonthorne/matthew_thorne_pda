...
describe('calculator functionality', function() {
  ...
  it('should have a working zero button', function(){
    running_total = element(by.css('#running_total'))
  ...
  it('should be able to return an error when you divide by zero', function(){
      running_total = element(by.css('#running_total'))
      element(by.css('#number2')).click();
      element(by.css('#operator_divide')).click();
      element(by.css('#number0')).click();
      element(by.css('#operator_equals')).click();
      expect(running_total.getAttribute('value')).to.eventually.equal('You cannot divide numbers by zero')
      });
